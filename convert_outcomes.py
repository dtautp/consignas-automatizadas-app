...
def excel_to_outcomes(ruta_archivo, ruta_destino, nombre_archivo):
    ...
    if exist_criteria and exist_id_rubric:
        ...
        message = f"No se encontró las columnas de id_rubrica o criterios"
        return (message)
    ...
    valid_outcomes = (df_outcomes.object_type == 'outcome') & (df_outcomes.title.isnull()) & (df_outcomes.ratings_4.isnull()) & (df_outcomes.level_4.isnull()) & (df_outcomes.ratings_3.isnull()) & (df_outcomes.level_3.isnull()) & (df_outcomes.ratings_2.isnull()) & (df_outcomes.ratings_4.isnull()) & (df_outcomes.level_2.isnull()) & (df_outcomes.ratings_1.isnull()) & (df_outcomes.level_1.isnull())
    ...
    ## descargar outcomes
    df_outcomes.to_csv(ruta_destino+'/'+nombre_archivo+'_outcomes.csv', encoding='utf-8', index=False)
    print("Documentos exportados exitosamente.")
    return (nombre_archivo+'_outcomes.csv')